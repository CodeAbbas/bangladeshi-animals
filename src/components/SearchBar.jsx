              ...
              <div className="relative">
                ...
                {searchQuery.length > 0 && (
                  <button
                    type="button"
                    onClick={onClear}
                    className="absolute -right-px top-1/2 -translate-y-1/2 p-0.5 text-gray-400 hover:text-gray-600 rounded-full"
      ...
      <AnimatePresence>
        {isOpen && suggestions.length > 0 && (
          <motion.div
            ...
            className="absolute top-full left-0 z-10 w-[97%] mx-auto "
