...
export const categories = [
  ...
  { name: "Birds", icon: Bird, href: "#", color: "text-blue-500", category: "Bird" },
  { name: "Reptiles", icon: Turtle, href: "#", color: "text-green-600", category: "Reptile" },
  { name: "Amphibians", icon: Leaf, href: "#", color: "text-lime-500", category: "Amphibian" },
  { name: "Fish", icon: Fish, href: "#", color: "text-cyan-500", category: "Fish" },
  { name: "Invertebrates", icon: Bug, href: "#", color: "text-purple-500", category: "Invertebrate" },
];
