...
const HomePage = ({ navigateTo }) => (
  <PageTransition>
    {/* Hero Section */}
    <section className="relative bg-bangla-green h-[70svh] min-h-[460px] text-white flex items-center">
      <div
...
></div>
  ...
  Bangladesh
        ...
        <motion.button
  className="mt-10 bg-white/20 backdrop-blur-sm border border-white/40 text-white font-bold py-3 px-6 rounded-full text-lg tracking-wide shadow-xl hover:bg-white/30 hover:border-white/60 transition-all transform hover:scale-105"
